               ...
               <div className='mt-10 w-full max-w-lg mx-auto'>
                  ...
                  <RadioGroup onChange={setPaymentMethod} value={paymentMethod}>
                     <Stack direction='column'>
                        <Radio value='payPal' size='lg'>Pay pal</Radio>
                        <Radio value='stripe' disabled size='lg'>Stripe  (coming soon...)</Radio>
                        <Radio value='paystack' disabled size='lg'>Paystack (coming soon...)</Radio>
                     </Stack>
                  </RadioGroup>

                  <ButtonGroup flex w="100%" mt="20px" justifyContent="space-between">
                     <Button 
                        color="default.600" 
                        bg="gray.100" 
