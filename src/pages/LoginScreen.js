...
const LoginScreen = () => {
	...
	return (
		<AuthLayout>
			<LoginBody className="w-full md:w-[60%] bg-white py-10 lg:py-0 lg:min-h-[400px] overflow-hidden rounded-lg flex">
				<LeftBody className="hidden lg:block lg:w-1/2 h-[400px] px-[20px] py-[30px]">
				...
				<RightBody className="w-full lg:w-1/2 bg-white p-5 lg:p-[30px]">
					...
					>
						...
						<LoginButton
							type="submit"
							className="bg-secondary-600 w-full rounded-lg font-medium text-white py-3 px-20 mt-10"
						>
							{isLoading ? (
